...
plot \
 'data/netperfdata2.babel.throughput'    using (1):2 notitle ls 2 lc 1 lw 2,\
 'data/netperfdata2.batadv.throughput'   using (2):2 notitle ls 2 lc 2 lw 2,\
 'data/netperfdata2.bmx6.throughput'     using (3):2 notitle ls 2 lc 3 lw 2,\
 'data/netperfdata2.olsr.throughput'     using (4):2 notitle ls 2 lc 4 lw 2;
