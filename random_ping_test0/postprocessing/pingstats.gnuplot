...
plot \
 'data/allpings2babel.txt'  using (1):3 notitle ls 2 lc 1 lw 2,\
 'data/allpings2badv.txt'   using (2):3 notitle ls 2 lc 2 lw 2,\
 'data/allpings2olsr.txt'   using (3):3 notitle ls 2 lc 3 lw 2,\
 'data/allpings2bmx6.txt'   using (4):3 notitle ls 2 lc 4 lw 2;
